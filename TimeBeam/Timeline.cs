...
namespace TimeBeam
{
    ...
    public partial class Timeline : Control
    {
        ...
        /// </summary>
        private int _trackLabelWidth = 150;
        ...
        private void DrawTracks(IEnumerable<ITimelineTrack> tracks, Graphics graphics)
        {
            ...
            foreach (ITimelineTrack track in tracks)
            {
                ...
                Color trackColor = ColorHelper.AdjustColor(track.BackgroundColor, 0, -0.1, -0.2);
        ...
        private void DrawTrackLabels(Graphics graphics)
        {
            foreach (IMultiPartTimelineTrack track in _tracks)
            {
                ...
                graphics.DrawString(track.DisplayText, _labelFont, Brushes.LightGray, labelRect);
            }
        }
